...
Results: 
/i Using images and examples of your code, compare the stock performance between 2017 and 2018, as well as the execution times of the original script and the refactored script. 
...
[^1]  Models of economic structures in different nations as well as their formation to changes over time can be translated as a word overlay chart infographic 
[2]   Method of positing the possibility of tax returns to be paid over tax-deductible donations to nonprofit(501)(b) for individual donors within one standard deviation on the upper limit $ of the income that the majority of US constituents make,  
[^3]  Investing in an energy stock by itself is not guaranteed to have any effect on the development, research, deployment, and necessary policies that implement green energy. 
[5]   Allreps.com
[6]   conceptual ballPit of varying sizes, chromas, fuzz, shapes, scutoid, dimensions 
[8]   face photo input inserts into a random meme, no cache
[9]   the comprehensive racism/sexism rehabilitation program
...
[12]  Why does the dataset for 2018 start 3?
